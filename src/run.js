...
async function main() {
  ...
  const run = {
    ...
    notCovered: [
      ...
      "UTC-fix cron (33 14 * * *) DST-viselkedése — 2026-08-26: a cron 14:33 UTC-re került (esti kézbesítés, user-döntés, ld. ARCHITEKTURA 3.). Egy fix UTC-cron nem tud egész évben 16:33 helyit: 14:33 UTC nyáron 16:33 (CEST), TÉLEN 15:33 (CET), így a „16:30 után\" invariáns télen egy cronnal NEM tartható — ha a téli 16:30-utániság kell, 15:33 UTC-re kell váltani. A korábbi 08:43 UTC / 15:00-s SLA elévült (az esti sáv a szándék); a sorállás ehhez a slothoz üzemeltetés közben mérendő (F4/infra)",
