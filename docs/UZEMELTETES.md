...
- **29 aktív forrás** (A-kaszt; 2026-08-28: a végleg megszűnt **szabadeu nyugdíjazva** — a
  `revisit:"never"` mostantól kizárja a gyűjtésből, config-tombstone marad, nincs napi RESZLEGES.
  2026-08-31: **forrás-bővítés 1. csomag +3** — `tarki` (Tárki RSS), `tk_szoc` (TK ELTE
  Szociológia), `tk_pol` (TK ELTE Politikatudomány), mind A-kaszt feed, kind=intezet, Hazai.
