...
- **54 aktív forrás** (A-kaszt; 2026-08-28: a végleg megszűnt **szabadeu nyugdíjazva** — a
  ...
  **+ 6. csomag SCRAPE-only:** `polcapital` (Political Capital, list_url + per-forrás htmllist-parser).
